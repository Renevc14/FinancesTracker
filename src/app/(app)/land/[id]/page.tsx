...
export default async function LandDetailPage({
  ...
  return (
    <div className="space-y-8">
      <div>
        <Link href="/land" className="text-xs text-[var(--accent)] hover:underline">
          ← Terrenos
        </Link>
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          <Stat label="Precio contrato" value={formatMoney(lot.contract.priceLocal, "BOB")} />
      ...
      <section className="space-y-3">
        <h2 className="font-display text-xl">Contrato</h2>
      ...
      <section className="space-y-3">
        <h2 className="font-display text-xl">Pagos</h2>
      ...
      <section className="space-y-3">
        <h2 className="font-display text-xl">Cronograma</h2>
        {overdue.length > 0 && (
    ...
    status === "paid"
      ...
      : status === "overdue"
        ...
        : status === "due"
          ? "text-[var(--warn)]"
          : "text-[var(--muted)]";
  return <p className={`text-[10px] uppercase tracking-wide ${color}`}>{status}</p>;
}
